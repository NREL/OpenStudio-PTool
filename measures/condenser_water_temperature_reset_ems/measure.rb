...
#start the measure
class CondenserWaterTemperatureResetEms < OpenStudio::Ruleset::WorkspaceUserScript

  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "CondenserWaterTemperatureResetEms"
  end
  ...
  def run(workspace, runner, user_arguments)
    ...
    ems_path = '../CondenserWaterTemperatureResetEms/ems_condenser_water_temperature_reset.ems'
    json_path = '../CondenserWaterTemperatureResetEms/ems_results.json'
...
CondenserWaterTemperatureResetEms.new.registerWithApplication