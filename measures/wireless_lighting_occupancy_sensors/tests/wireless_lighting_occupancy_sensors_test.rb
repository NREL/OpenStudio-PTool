...
class WirelessLightingOccupancySensorsTest < MiniTest::Test
  ...
  def test_do_not_apply
    ...
    measure = WirelessLightingOccupancySensors.new
  ...
  def test_should_apply_sensors
    ...
    model.save(OpenStudio::Path.new("#{Dir.pwd}/small_office_1980-2004_with_occ.osm"),true)
