...
#start the measure
class ElectrochromicWindows < OpenStudio::Ruleset::WorkspaceUserScript
    ...
    model.getThermalZones.each do |zone|
      ...
      if zone.primaryDaylightingControl.is_initialized
        ...
        if centroid.nil?
          ...
          runner.registerInfo("Zone #{zone_name} does not have a daylighting sensor; addied one to control the electrochromic windows.")
        end
      end
    end
