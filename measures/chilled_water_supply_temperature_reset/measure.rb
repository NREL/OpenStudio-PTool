...
# start the measure
class ChilledWaterSupplyTemperatureReset < OpenStudio::Ruleset::ModelUserScript

  # human readable name
  def name
    return "Chilled Water Supply Temperature Reset"
  end
	...
	return args
	  ...
	  def run(model, runner, user_arguments)
		super(model, runner, user_arguments)
			...
			end #end the cooling loop
			
			if
				cooling_plant_loop_array_initial.length == 0
...
ChilledWaterSupplyTemperatureReset.new.registerWithApplication
