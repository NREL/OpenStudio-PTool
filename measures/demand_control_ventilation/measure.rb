...
# start the measure
class DemandControlVentilation < OpenStudio::Ruleset::ModelUserScript

  # human readable name
  def name
    return "Demand Control Ventilation"
  end
  ...
  def modeler_description
    return "For each AirLoop, if DCV is not already enabled, enable it via the Controller:MechanicalVentilation object and also reduce the minimum OA flow rate to zero to enable maximum OA turndown."
  end
...
DemandControlVentilation.new.registerWithApplication
