...
class BrushlessDCCompressorMotorsTest < MiniTest::Test
  ...
  def test_do_not_apply
    ...
    measure = BrushlessDCCompressorMotors.new
  ...
  def test_should_apply_sensors
    ...
    model.save(OpenStudio::Path.new("#{Dir.pwd}/small_office_1980-2004_lower_pd.osm"),true)
