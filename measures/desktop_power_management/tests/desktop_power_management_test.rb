...
class DesktopPowerManagementTest < MiniTest::Test
  ...
  def test_do_not_apply
    ...
    measure = DesktopPowerManagement.new
  ...
  def test_apply_to_weekdays_only
    ...
    model.save(OpenStudio::Path.new("#{Dir.pwd}/secondary_school_90.1-2010_with_desktop_pwr_mgmt.osm"),true)  
