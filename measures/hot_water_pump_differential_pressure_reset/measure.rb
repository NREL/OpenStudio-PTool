  ...
  def run(model, runner, user_arguments)
	...
	qualified_cooling_plant_loop_array.each do |qualified_loop|
		...
		if qualified_cooling_plant_loop_array.size == 0 			
			runner.registerAsNotApplicable("The model does not contain any hot water loops with a plantLoop.commonPipeSimulation setting = 'Common Pipe'. The measure is not applicible.")
			return true
		end
