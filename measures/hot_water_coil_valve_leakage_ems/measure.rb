...
#start the measure
class HotWaterCoilValveLeakageEms < OpenStudio::Ruleset::WorkspaceUserScript

  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "HotWaterCoilValveLeakageEms"
  end
  ...
  def run(workspace, runner, user_arguments)
    ...
    ems_path = '../HotWaterCoilValveLeakageEms/ems_hot_water_coil_valve_leakage.ems'
    json_path = '../HotWaterCoilValveLeakageEms/ems_results.json'
...
HotWaterCoilValveLeakageEms.new.registerWithApplication