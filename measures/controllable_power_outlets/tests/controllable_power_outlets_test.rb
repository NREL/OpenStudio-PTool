...
class ControllablePowerOutletsTest < MiniTest::Test
  ...
  def test_do_not_apply
    ...
    measure = ControllablePowerOutlets.new
  ...
  def test_apply_to_weekdays_only
    ...
    model.save(OpenStudio::Path.new("#{Dir.pwd}/secondary_school_90.1-2010_with_controllable_outlets.osm"),true)  
