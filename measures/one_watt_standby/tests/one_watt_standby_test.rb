...
class OneWattStandbyTest < MiniTest::Test
  ...
  def test_apply_to_weekdays_only
    ...
    model.save(OpenStudio::Path.new("#{Dir.pwd}/secondary_school_90.1-2010_with_one_w_standby.osm"),true)  
