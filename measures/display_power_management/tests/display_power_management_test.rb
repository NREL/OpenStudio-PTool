...
class DisplayPowerManagementTest < MiniTest::Test
  ...
  def test_do_not_apply
    ...
    measure = DisplayPowerManagement.new
  ...
  def test_apply_to_weekdays_only
    ...
    model.save(OpenStudio::Path.new("#{Dir.pwd}/secondary_school_90.1-2010_with_adv_pwr_strips.osm"),true)  
