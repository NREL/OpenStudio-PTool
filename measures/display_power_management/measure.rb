...
# start the measure
class DisplayPowerManagement < OpenStudio::Ruleset::ModelUserScript
  ...
  def run(model, runner, user_arguments)
    ...
    model.getElectricEquipments.each do |equip|
      if equip.schedule.empty?
        ...
        runner.registerInfo("Schedule for the electric equipment object named '#{equip.name}' was reduced to simulate the application of Display Power Management.")
      end
    end
    ...
    runner.registerFinalCondition("#{original_equip_schs.uniq.size} schedule(s) were edited to reflect the addition of Display Power Management to the monitors in the building.")
...
DisplayPowerManagement.new.registerWithApplication
