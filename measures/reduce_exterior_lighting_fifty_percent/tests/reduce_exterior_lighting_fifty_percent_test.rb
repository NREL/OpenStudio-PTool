...
class ReduceExteriorLightingFiftyPercentsTest < MiniTest::Unit::TestCase

  def test_ReduceExteriorLightingFiftyPercent

    # Create an instance of the measure
    measure = ReduceExteriorLightingFiftyPercent.new
