...
class PredictiveThermostatsTest < MiniTest::Test
  ...
  def test_do_not_apply
    ...
    measure = PredictiveThermostats.new
  ...
  def test_should_apply_sensors_office
  ...
  def test_should_apply_sensors_school
