...
#start the measure
class OptimalStartStopEms < OpenStudio::Ruleset::WorkspaceUserScript

  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "OptimalStartStopEms"
  end
  ...
  def run(workspace, runner, user_arguments)
    ...
    ems_path = '../OptimalStartStopEms/optimal_start_stop.ems'
    json_path = '../OptimalStartStopEms/ems_results.json'
...
OptimalStartStopEms.new.registerWithApplication